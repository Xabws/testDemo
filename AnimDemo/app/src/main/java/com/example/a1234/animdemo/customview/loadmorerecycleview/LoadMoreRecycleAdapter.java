package com.example.a1234.animdemo.customview.loadmorerecycleview;
...
public abstract class LoadMoreRecycleAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public abstract VH LoadMoreonCreateViewHolder(ViewGroup parent, int viewType);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return LoadMoreonCreateViewHolder(parent, viewType);
    }
