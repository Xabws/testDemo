...
public class DrawerView extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            child.layout(curLeft, HandlerHeight, curLeft + curWidth, childRect.bottom);
            //更新maxHeight和curLeft
    ...
    private void initAnim() {
        ...
        switch (drawerStatus) {
            case DRAWEROPEN:
                drawerAnim = ValueAnimator.ofInt(HandlerHeight, childRect.top);
                break;
            case DRAWERCLOSE:
                drawerAnim = ValueAnimator.ofInt(childRect.top, HandlerHeight);
                break;
        }
        drawerAnim.setDuration(300);
        drawerAnim.setInterpolator(new DrawerInterpolater());
    ...
    private class DrawerInterpolater extends BaseInterpolator {
        float tension = 1.3f;
