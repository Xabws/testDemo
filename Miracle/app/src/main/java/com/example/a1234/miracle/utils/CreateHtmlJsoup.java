...
public class CreateHtmlJsoup {
     ...
     * 生成HTML到本地的临时目录中
     */
    public static String makeHeatMapHtml(Context context, String url) {
...
//        filepath = Environment.getExternalStorageDirectory()+"/aaa.temp/";
        ...
        copyURLToHtml(url, filepath, filename, ecoding);
     ...
     *
     * @param doc jsoup.nodes.Document
