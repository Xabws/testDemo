...
public class DateFormatUtil {
    ...
    /**
     * 日期字符串转时间戳	 * @param dateStr	 * @return
     */
    ...
    /**
     * 日期字符串转时间戳	 * @param dateStr	 * @param 格式 如"yyyy-mm-dd"	 * @return
     */
    ...
    /**
     * 字符串转日期，格式为："yyyy-MM-dd HH:mm:ss"	 * @param dateStr	 * @return
     */
    ...
    /**
     * 时间戳格式化输出（httl模版用）	 * 	 * @param ms		时间戳	 * @param format	格式化	 * @return
     */
    ...
    /**
     * 取BigDecimal类型数的整数或小数部分（httl模版用）	 * 	 * @param b	值	 * @param mode	模式 0取整 1去小数部分	 * @return
     */
    ...
    /**
     * 计算两个日期之间差的天数（httl模版用）	 * 	 * @param ts1	时间戳1	 * @param ts2	时间戳2	 * @return
     */
    ...
    /**
     * 给手机加密中间四位加星号	 * 	 * @param mobile	 * @return
     */
    ...
    /**
     * BigDecimal类型数据相加	 * 	 * @param BigDecimal source	 * @param BigDecimal target	 * @return
     */
    ...
    /**
     * BigDecimal类型数据相减	 * 	 * @param BigDecimal source	 * @param BigDecimal target	 * @return
     */
    ...
    /**
     * 获取某周的第一天日期	 * @param week 0 当周 1 上一周 -1 下一周	 * @return
     */
    ...
    /**
     * HH:mm:ss格式时间转换为1970-01-01日的时间戳（也就是只有时间没有日期的情况要求使用时间戳表示时间）	 * @author DingJiaCheng	 *
     */
    ...
    /**
     * 时间戳转换为HH：mm：ss格式时间(日期去除)	 * @author DingJiaCheng	 *
     */
